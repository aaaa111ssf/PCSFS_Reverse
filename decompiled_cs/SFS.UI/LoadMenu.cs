...
public class LoadMenu : Screen_Menu
{
	...
	public void Delete()
	{
		...
		{
			MenuGenerator.OpenConfirmation(CloseMode.Current, () => string.Concat(Loc.main.Delete_File_With_Type.Inject(name, "filename").InjectField((implementation.Title == Loc.main.Blueprints_Menu_Title) ? Loc.main.Blueprint : Loc.main.Quicksave, "filetype", formatCapitalization: true), "?"), () => Loc.main.Delete, delegate
			{
				Delete(name);
			}, () => Loc.main.Cancel);
		}
