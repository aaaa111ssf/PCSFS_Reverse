...
public class AstronautMenu : Screen_Menu
{
	...
	{
		Menu.textInput.Open(Loc.main.Cancel, Loc.main.Create, delegate(string[] textInput)
		{
			Create(textInput[0]);
	...
	public void FireAstronaut()
	{
		if (GetSelected(out var selected))
		{
			...
			MenuGenerator.OpenConfirmation(CloseMode.Current, () => Loc.main.Discharge_Astronaut.Inject(astronaut, "astronaut"), () => Loc.main.Discharge, delegate
			{
