...
public class TextBox : Screen_Menu
{
	...
	public TouchScreenKeyboardType keyboardType = TouchScreenKeyboardType.NamePhonePad;
	...
	public override void OnOpen()
	{
		...
		cursorPosition = text.Length;
		keyboard = TouchScreenKeyboard.Open(text.ToString(), keyboardType, autocorrection: false, multiline, secure: false, alert: true, "", 0);
	}
