...
public static class TrajectoryDrawer
{
	...
	public static void DrawOrbit(this Orbit orbit, Color c, bool drawStats, bool drawStartText, bool drawEndText, LineDrawer lineDrawer)
	{
		...
		case PathType.Escape:
		{
			...
			bool flag5 = LanguageSettings.main.settings.codeName == "" || LanguageSettings.main.settings.codeName == "English";
		...
		case PathType.Encounter:
		{
			...
			bool flag = LanguageSettings.main.settings.codeName == "" || LanguageSettings.main.settings.codeName == "English";
