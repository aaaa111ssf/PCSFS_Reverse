...
public class MapPlanet : SelectableObject
{
	...
	public double FocusDistance => Math.Min((planet.satellites.Length != 0) ? (planet.satellites.Select((Planet satellite) => satellite.orbit.apoapsis).Max() * 10.0) : double.PositiveInfinity, planet.SOI * 4.0);
