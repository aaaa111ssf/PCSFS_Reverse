...
public class VelocityArrowDrawer : MonoBehaviour
{
	...
	private void OnLocationChange(Location _, Location location)
	{
		...
		if (location.planet.codeName != Base.planetLoader.spaceCenter.address && (flag ? location.GetTerrainHeight(clampToWater: true) : location.Height) < num7 && location.VerticalVelocity < 25.0)
		{
