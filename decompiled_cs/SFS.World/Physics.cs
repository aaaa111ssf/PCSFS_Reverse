...
public class Physics : MonoBehaviour
{
	...
	private (Double2, Double2, double) lastTrajectory_Input;
	...
	private void Update()
	{
		...
		if (!PhysicsObject.PhysicsMode)
		{
			...
			if (location.velocity.Value.Mag_MoreThan(0.1) && location.planet.Value.IsInsideTerrain(location.position, 0.5, clampToWater: true) && !(trajectory.paths[0] is Stationary))
			{
	...
	public Trajectory GetTrajectory()
	{
		if (PhysicsObject.PhysicsMode)
		{
			...
			(Double2, Double2, double) tuple = (value.position - PhysicsObject.LocalVelocity * Time.deltaTime, value.velocity, value.time);
			(Double2, Double2, double) tuple2 = tuple;
			(Double2, Double2, double) tuple3 = lastTrajectory_Input;
			if (tuple2.Item1 != tuple3.Item1 || tuple2.Item2 != tuple3.Item2 || tuple2.Item3 != tuple3.Item3)
			{
				lastTrajectory_Input = tuple;
				lastTrajectory = Trajectory.CreateTrajectory(value);
			}
