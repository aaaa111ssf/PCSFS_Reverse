...
public class EndMissionMenu : Screen_Menu
{
	...
	public void Complete()
	{
		...
		if ((bool)recoveryTarget.isPlayer)
		{
			...
			MenuGenerator.OpenMenu(CancelButton.None, CloseMode.None, new SizeSyncerBuilder(out var carrier), ButtonBuilder.CreateIconButton(carrier, buttonIcons.newRocket, () => Loc.main.Build_New_Rocket, delegate
			{
				PickOption(GameManager.main.ExitToBuild);
			}, CloseMode.None), ButtonBuilder.CreateIconButton(carrier, buttonIcons.exit, () => Loc.main.Go_To_Space_Center, delegate
			{
