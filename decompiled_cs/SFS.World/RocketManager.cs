...
public class RocketManager : MonoBehaviour
{
	...
	public static void MergeRockets(Rocket rocket_A, Part part_A, Rocket rocket_B, Part part_B, Vector2 anchor)
	{
		...
		Vector2 linearVelocity = (rocket_A.rb2d.linearVelocity * rocket_A.rb2d.mass + rocket_B.rb2d.linearVelocity * rocket_B.rb2d.mass) / num;
		...
		rocket_A.rb2d.linearVelocity = linearVelocity;
